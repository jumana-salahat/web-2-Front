    ...
    <div className="fitgenie-auth-page">
      <div className="heroWrapper">
        ...
        <section className="auth-hero-section">
          ...
          <p>
            AI-powered workout plans, personalized nutrition guides,
            and progress tracking — all tailored to your goals.
          </p>
      ...
      <div className="authContainer">
        ...
        {!isFirebaseConfigured && (
          ...
          >
            Firebase env vars are missing — copy your
            `.env` keys and restart
